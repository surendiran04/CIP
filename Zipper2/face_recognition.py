...
def recognize_faces(image_path):
    """Detect and recognize multiple faces, return list of face_ids or 'not_found'."""
        ...
        for i, detection in enumerate(results.detections):
            ...
            try:
                ...
                if result and not result[0].empty:
                    ...
                    if face_record:
                        recognized_results.append(str(face_record["_id"]))
                    else:
                        recognized_results.append("not_found")
                else:
                    recognized_results.append("not_found")
